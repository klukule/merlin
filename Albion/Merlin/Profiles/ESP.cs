        ...
        IEnumerator GetViews()
        {
            while (true)
            {
                ...
                try
                {
                    ...
                    {
                        var resourceTypeString = view.GetResourceType();
        ...
        private void DrawResourceESPs()
        {
            ...
            foreach (var view in resources)
            {
                ...
                try
                {
                    ...
                    {
                        valid = harvestable.CanLoot(localPlayer) && harvestable.GetCurrentCharges() > 0;
                        enchantmentLevel = harvestable.GetRareState();
        ...
        private void DrawPlayerESPs()
        {
            ...
            foreach (var player in players)
            {
                ...
                try
                {
                    ...
                    if (player.PlayerCharacter.jm() != localPlayer.PlayerCharacter.jm())
                    {
